    ...
    libs: [
      {
        ...
        resolveStyle: (name) => {
          ...
          const componentName = Object.prototype.hasOwnProperty.call(replaceList, name) ? replaceList[name] : name
          return `@arco-design/web-vue/es/${componentName}/style/index.js`
        }
      }
    ]
  })
